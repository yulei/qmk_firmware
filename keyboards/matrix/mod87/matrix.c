...
void matrix_init(void)
{
    ...
    palSetLineMode(LINE_COL_16, PAL_MODE_OUTPUT_PUSHPULL);

    palSetLineMode(LINE_ROW_0, PAL_MODE_INPUT_PULLDOWN);
...
uint8_t matrix_scan(void)
{
    for (int col = 0; col < MATRIX_COLS; col++) {
        ...
        switch (col) {
            ...
            case 15: palSetLine(LINE_COL_16); break;
        }
        ...
        data = (
            (palReadLine(LINE_ROW_0) << 0 ) |
            (palReadLine(LINE_ROW_1) << 1 ) |
            (palReadLine(LINE_ROW_2) << 2 ) |
            (palReadLine(LINE_ROW_3) << 3 ) |
            (palReadLine(LINE_ROW_4) << 4 ) |
            (palReadLine(LINE_ROW_5) << 5 )
        );
        ...
        switch (col) {
            ...
            case 15: palClearLine(LINE_COL_16); break;
        }
