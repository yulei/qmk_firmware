...
{
    switch (state) { case LOGO_STATE_OFF: print("set logo off\n"); is3236_set_led_state(LOGO_U_INDEX, 0, 0);
    ...
    case LOGO_STATE_ON:
        ...
        */
        is3236_set_led_color(LOGO_U_INDEX, LOGO_COLOR_R, LOGO_COLOR_G, LOGO_COLOR_B); 
        is3236_set_led_color(LOGO_L_INDEX, LOGO_COLOR_R, LOGO_COLOR_G, LOGO_COLOR_B); 
        is3236_set_led_color(LOGO_R_INDEX, LOGO_COLOR_R, LOGO_COLOR_G, LOGO_COLOR_B); 
